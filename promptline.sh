...
function __promptline {
  ...
  local a_fg="${wrap}0${end_wrap}"
  local a_bg="${wrap}34${end_wrap}"
  local a_sep_fg="${wrap}34${end_wrap}"
  local b_fg="${wrap}0${end_wrap}"
  local b_bg="${wrap}34${end_wrap}"
  local b_sep_fg="${wrap}34${end_wrap}"
  local c_fg="${wrap}0${end_wrap}"
  local c_bg="${wrap}34${end_wrap}"
  local c_sep_fg="${wrap}34${end_wrap}"
  local warn_fg="${wrap}0${end_wrap}"
  local warn_bg="${wrap}31${end_wrap}"
  local warn_sep_fg="${wrap}31${end_wrap}"
  local x_fg="${wrap}0${end_wrap}"
  local x_bg="${wrap}34${end_wrap}"
  local x_sep_fg="${wrap}34${end_wrap}"
  local y_fg="${wrap}0${end_wrap}"
  local y_bg="${wrap}34${end_wrap}"
  local y_sep_fg="${wrap}34${end_wrap}"
  if [[ -n ${ZSH_VERSION-} ]]; then
