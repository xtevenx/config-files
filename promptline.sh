...
function __promptline {
  ...
  local c_fg="${wrap}34${end_wrap}"
  local c_bg="${wrap}49${end_wrap}"
  local c_sep_fg="${wrap}34${end_wrap}"
  local warn_fg="${wrap}31${end_wrap}"
  local warn_bg="${wrap}49${end_wrap}"
  local warn_sep_fg="${wrap}31${end_wrap}"
  local x_fg="${wrap}34${end_wrap}"
  local x_bg="${wrap}49${end_wrap}"
